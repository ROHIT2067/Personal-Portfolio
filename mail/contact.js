...
function validateForm() {
    ...
    if (name === "") {
        ...
        errname.textContent = "Username must start with a letter and be 2–20 characters long (letters, numbers, underscores).";
        isValid = false;
    }
...
function sendMail(){
    ...
    emailjs.send("service_xp577ga","template_lyqlhho",params).then(alert("Send the message succesfully"));
